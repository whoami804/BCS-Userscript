...
// @version      0.9.0-s1-1-safari-deferred-rc1
...
// @updateURL    https://raw.githubusercontent.com/whoami804/BCS-Userscript/feat/s1-1-safari-deferred-evidence/control-suite-boosteroid-s1-1-safari-deferred-rc1.user.js
...
const VERSION = '0.9.0-s1-1-safari-deferred-rc1';
...
function updateUI(sample=null) {
  ...
  const immersiveSupported=!!CAP.display.fullscreen;
...
<div class="bcs-body">
  ...
  <div class="bcs-card"><div class="bcs-card-top"><div class="bcs-card-main"><div class="bcs-label">Immersive</div><div id="bcs-immersive-desc" class="bcs-desc">Abre o jogo em tela cheia.</div></div><span class="bcs-badge bcs-live">AO VIVO</span></div><div class="bcs-control"><button id="bcs-immersive-toggle" class="bcs-btn" type="button">ATIVAR IMERSIVO</button><button id="bcs-immersive-retry" class="bcs-btn" type="button" style="display:none;margin-top:7px">RECAPTURAR</button></div></div>
...
function shouldUseSafariCleanVideoSurface() {
